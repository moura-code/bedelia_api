# Generated by Django 4.2.6 on 2025-10-28 01:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('code', models.CharField(db_index=True, help_text='Subject code (e.g., UCB/FIng code)', max_length=16)),
                ...
                ('dept', models.CharField(blank=True, help_text='Department offering this subject', max_length=100, null=True)),
                ...
                ('program', models.ForeignKey(blank=True, help_text='Academic program this subject belongs to', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subjects', to='api.program')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='program',
            index=models.Index(fields=['plan_year'], name='idx_program_year'),
        ),
        migrations.AddField(
            model_name='offeringlink',
            name='offering',
            field=models.ForeignKey(help_text='Offering this link is associated with', on_delete=django.db.models.deletion.CASCADE, related_name='links', to='api.offering'),
        ),
        migrations.AddField(
            model_name='offering',
            name='subject',
        ...
        migrations.AddField(
            ...
            name='from_offering',
            field=models.ForeignKey(blank=True, help_text='Source offering (if from_type is OFFERING)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dep_out_offering', to='api.offering'),
        ),
        migrations.AddField(
            model_name='dependencyedge',
            name='from_subject',
            field=models.ForeignKey(blank=True, help_text='Source subject (if from_type is SUBJECT)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dep_out_subject', to='api.subject'),
        ),
        migrations.AddField(
            model_name='dependencyedge',
            name='group',
            field=models.ForeignKey(help_text='Requirement group this dependency comes from', on_delete=django.db.models.deletion.CASCADE, related_name='dependency_edges', to='api.requirementgroup'),
        ),
        migrations.AddField(
            model_name='dependencyedge',
            name='to_offering',
            field=models.ForeignKey(help_text='Target offering that has this dependency', on_delete=django.db.models.deletion.CASCADE, related_name='dep_in', to='api.offering'),
        ),
        migrations.AddField(
            model_name='auditsource',
            name='offering',
            field=models.ForeignKey(blank=True, help_text='Associated offering (if applicable)', null=True, on_delete=django.db.models.deletion.CASCADE, to='api.offering'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            model_name='subjectequivalence',
            constraint=models.CheckConstraint(check=models.Q(('subject_a', models.F('subject_b')), _negated=True), name='ck_equiv_not_self'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='subject',
            index=models.Index(fields=['program'], name='idx_subjects_program'),
        ),
        migrations.AddConstraint(
            model_name='subject',
            constraint=models.UniqueConstraint(fields=('program', 'code'), name='uq_subject_program_code'),
        ),
        migrations.AddConstraint(
            model_name='subject',
            constraint=models.CheckConstraint(check=models.Q(('semester__in', [1, 2]), ('semester__isnull', True), _connector='OR'), name='ck_subject_semester_in_1_2_or_null'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            model_name='requirementitem',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('target_type', 'SUBJECT'), ('target_subject__isnull', False), ('target_offering__isnull', True)), models.Q(('target_type', 'OFFERING'), ('target_offering__isnull', False), ('target_subject__isnull', True)), _connector='OR'), name='ck_item_target_exclusive'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            model_name='requirementgrouplink',
            constraint=models.CheckConstraint(check=models.Q(('parent_group', models.F('child_group')), _negated=True), name='ck_group_no_self_link'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            model_name='requirementgroup',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('scope', 'ANY'), ('min_required__gte', 1)), models.Q(('scope__in', ['ALL', 'NONE']), ('min_required__isnull', True)), _connector='OR'), name='ck_group_min_required_semantics'),
        ),
        migrations.AddIndex(
            model_name='offeringlink',
            index=models.Index(fields=['offering'], name='idx_offering_links_offering'),
        ),
        migrations.AddIndex(
            model_name='offeringlink',
            index=models.Index(fields=['kind'], name='idx_offering_links_kind'),
        ),
        migrations.AddIndex(
            model_name='offering',
        ...
        migrations.AddConstraint(
            model_name='offering',
            constraint=models.CheckConstraint(check=models.Q(('semester__in', [1, 2, 3]), ('semester__isnull', True), _connector='OR'), name='ck_offering_semester_in_1_2_3_or_null'),
        ),
        migrations.AddIndex(
            model_name='dependencyedge',
        ...
        migrations.AddConstraint(
            model_name='dependencyedge',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('from_type', 'SUBJECT'), ('from_subject__isnull', False), ('from_offering__isnull', True)), models.Q(('from_type', 'OFFERING'), ('from_offering__isnull', False), ('from_subject__isnull', True)), _connector='OR'), name='ck_dep_from_target_exclusive'),
        ),
        migrations.AddIndex(
            model_name='auditsource',
            index=models.Index(fields=['offering'], name='idx_audit_offering'),
        ),
        migrations.AddIndex(
            model_name='auditsource',
            index=models.Index(fields=['fetched_at'], name='idx_audit_time'),
        ),
        migrations.AddIndex(
            model_name='auditsource',
            index=models.Index(fields=['status'], name='idx_audit_status'),
        ),
        migrations.AddIndex(
            model_name='auditsource',
            index=models.Index(fields=['parsed_ok'], name='idx_audit_parsed'),
        ),
    ]
