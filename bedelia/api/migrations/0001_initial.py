# Generated by Django 5.2.7 on 2025-11-19 05:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('fecha_modificacion', models.DateTimeField(auto_now=True)),
                ('padre', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hijos', to='api.posprevianodo', verbose_name='Nodo padre')),
                ('plan_materia', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='posprevias', to='api.planmateria', verbose_name='Materia en plan que es requerida')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('tipo', models.CharField(choices=[('PLAN_MATERIA', 'Materia en plan que requiere esta'), ('TEXTO', 'Condición libre')], max_length=20, verbose_name='Tipo de condición')),
                ('texto', models.CharField(blank=True, max_length=500, verbose_name='Descripción textual')),
                ('orden', models.IntegerField(default=0)),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('fecha_modificacion', models.DateTimeField(auto_now=True)),
                ('plan_materia_dependiente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='como_posprevia', to='api.planmateria', verbose_name='Materia dependiente')),
                ('nodo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='api.posprevianodo', verbose_name='Nodo LEAF')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='posprevianodo',
            index=models.Index(fields=['plan_materia'], name='idx_posprevia_plan_materia'),
        ),
        migrations.AddIndex(
            model_name='posprevianodo',
            index=models.Index(fields=['padre'], name='idx_posprevia_padre'),
        ),
        migrations.AddIndex(
            model_name='posprevianodo',
            index=models.Index(fields=['tipo'], name='idx_posprevia_tipo'),
        ),
        migrations.AddIndex(
            model_name='pospreviaitem',
            index=models.Index(fields=['nodo', 'orden'], name='idx_posprevia_item_nodo_orden'),
        ),
        migrations.AddIndex(
