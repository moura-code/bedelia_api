# Generated by Django 4.2.6 on 2025-11-13 02:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('fecha_modificacion', models.DateTimeField(auto_now=True)),
                ('carrera', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='planes', to='api.carrera')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semestre_sugerido', models.IntegerField(blank=True, null=True)),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('fecha_modificacion', models.DateTimeField(auto_now=True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['carrera', 'anio'], name='idx_plan_carrera_anio'),
        ),
        migrations.AlterUniqueTogether(
            name='planestudio',
